<%@page import="we.m2.board.util.StringUtil"%>
<%@page import="we.m2.board.vo.Board"%>
<%@page import="java.util.List"%>
<%@page import="we.m2.board.dao.BoardDao"%>
					...
					<tfoot>
						<tr>
							<td colspan="6">
								<div class="row">
									<div class="col-6">
										총 글 수 개(페이지번호/총 페이지 수)
									</div>
									<div class="col-6 text-right">
										<a class="btn btn-danger btn-sm">글쓰기</a>
									</div>
								</div>
							</td>
						</tr>
