			...
			<div class="col-8">
				<div class="card">
					<div class="card-header text-center" style="background-color: PeachPuff">
						<h4>${newUser.name }님, 회원 정보를 확인하세요.</h4>
					</div>
					<div class="card-body">
						<div>
							<p>회원 번호 : ${newUser.no }</p>
							<p>회원 별명 : ${newUser.name }</p>
							<p>아  이  디 : ${newUser.id }</p>
							<p>가입 메일 : ${newUser.email }</p>
						</div>
					</div>
					<div class="card-footer" style="background-color: #fff1e6;">
						<div class="text-center">
							<a class="btn btn-danger btn-lg" href="../board/list.we">게시판으로</a>
						</div>
					</div>
				</div>
			</div>
